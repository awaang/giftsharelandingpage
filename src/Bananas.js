...
function Banana({ index, z, speed }) {
  ...
  const { nodes, materials } = useGLTF('/giftboxpink.glb')
  ...
  return (
    <Detailed ref={ref} distances={[0, 65, 80]}>
      <mesh geometry={nodes.Giftbox01.geometry} material={materials.Yellow01} />
      <mesh geometry={nodes.Giftbox01.geometry} material={materials.Pink01} />
      <mesh geometry={nodes.Giftbox01.geometry} material={materials.Pink01} />
      <mesh geometry={nodes.Giftbox02.geometry} material={materials.Pink01} />
      <mesh geometry={nodes.Giftbox02.geometry} material={materials.Pink01} />
      <mesh geometry={nodes.Giftbox02.geometry} material={materials.Pink01} />
    </Detailed>
  )
  // return (
  //   <Detailed ref={ref} distances={[0, 65, 80]}>
  //     <mesh geometry={nodes.Giftbox01.geometry} material={materials.Yellow01} material-emissive="#ffffff" />
  //     <mesh geometry={nodes.Giftbox01.geometry} material={materials.Pink01} material-emissive="#9E2129" />
  //     <mesh geometry={nodes.Giftbox01.geometry} material={materials.Pink01} material-emissive="#ffffff" />
...
export default function Bananas({ speed = 1, count = 80, depth = 80, easing = (x) => Math.sqrt(1 - Math.pow(x - 1, 2)) }) {
  return (
    ...
    <Canvas gl={{ antialias: false }} dpr={[1, 1.5]} camera={{ position: [0, 0, 10], fov: 20, near: 0.01, far: depth + 15 }}>
      <color attach="background" args={['#9E2129']} />
